...
require (
	...
	github.com/metal-stack/gardener-extension-provider-metal v0.20.20
...
require (
	...
	github.com/metal-stack/duros-controller v0.6.2 // indirect
	github.com/metal-stack/firewall-controller-manager v0.2.3 // indirect
